...
const QString BITCOIN_IPC_PREFIX("sahacoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/sahacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/sahacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/sahacoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click sahacoin: links
...
//
// OSX-specific way of handling sahacoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in sahacoin: URIs
