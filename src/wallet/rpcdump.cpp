...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"sahacoinaddress\"\n"
            "\nReveals the private key corresponding to 'sahacoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"sahacoinaddress\"   (string, required) The sahacoin address for the private key\n"
            "\nResult:\n"
