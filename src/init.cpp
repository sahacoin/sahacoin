...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sahacoin/sahacoin>";
    const std::string URL_WEBSITE = "<https://sahacoin.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The SahaCoin Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find SahaCoin useful. "
