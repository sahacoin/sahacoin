...
These are the dependencies currently used by SahaCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/sahacoinnl
Keybase  - https://keybase.io/team/sahacoin/
