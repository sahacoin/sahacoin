...
Note
---------------------
Always use absolute paths to configure and compile sahacoin and the dependencies,
...
This will build sahacoin-qt as well if the dependencies are met.
...
Once these are installed, they will be found by configure and a sahacoin-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip sahacoind" to strip the debug
...
# Pick some path to install BDB to, here we create a directory within the sahacoin directory
...
Security
--------
To help make your sahacoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, sahacoin should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, sahacoin may be compiled in
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://gitlab.com/sahacoin/sahacoin.git
    cd sahacoin/
    ./autogen.sh
